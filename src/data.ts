...
export const servicesData: Service[] = [
  {
    ...
    description: 'HomeWorks Realty adalah agen properti profesional yang melayani konsultasi, pemasaran, serta transaksi jual, beli, dan sewa aset real estat (tanah, rumah, ruko, hingga gedung). Kami menjamin keamanan transaksi dengan kurasi legalitas hukum yang ketat dan bebas sengketa. Kami juga menyediakan manajemen hunian sewa yang ramah anggaran bagi mahasiswa dan pekerja.',
  ...
  },
  {
    ...
    description: 'HomeWorks Engineering bertindak sebagai konsultan teknik sipil dan arsitektur untuk perencanaan awal, analisis struktural, hingga pengawasan teknis bangunan. Kami menghadirkan standar perhitungan presisi yang aman gempa serta efisien terhadap penggunaan material. Layanan kami meliputi pembuatan dokumen DED (gambar kerja cetak biru), gambar 3D, MEP, dan RAB akurat.',
  ...
  },
  {
    ...
    description: 'HomeWorks Build adalah kontraktor pelaksana konstruksi fisik yang melayani pembangunan dari nol hingga renovasi skala besar maupun parsial. Kami menjamin transparansi anggaran (tanpa biaya siluman) dan ketepatan waktu proyek dengan sistem serah terima kunci. Layanan kami mencakup rumah tinggal, ruko, kos-kosan, infrastruktur jalan, dan garansi struktur.',
  ...
  },
  {
    ...
    description: 'HomeWorks Interior menyediakan jasa perancangan interior kustom dan tata letak ruang komersial maupun hunian privat. Kami memadukan nilai estetika visual dengan optimalisasi fungsi ruang untuk mencerminkan karakter pemiliknya. Seluruh produksi dikerjakan oleh pengrajin internal untuk menjamin detail sambungan dan finishing yang rapi.',
  ...
  },
  {
    ...
    description: 'HomeWorks Clean adalah penyedia jasa kebersihan profesional (deep cleaning) untuk hunian, ruko, kantor, dan pembersihan khusus pasca-renovasi. Kami juga melayani sanitasi vakum tungau kasur, sofa, karpet, dan gorden. Menggunakan peralatan modern dan bahan ramah lingkungan yang aman untuk anak-anak serta hewan peliharaan.',
  ...
  },
  {
    ...
    description: 'HomeWorks Care hadir sebagai solusi cepat tanggap untuk pelayanan teknis harian, perbaikan darurat, dan pemeliharaan berkala properti Anda. Kami melayani perbaikan instalasi listrik, perawatan/cuci AC, pompa air, pipa bocor, saluran tersumbat, hingga perbaikan atap. Didukung oleh teknisi berpengalaman yang jujur, cepat, dan bergaransi.',
  ...
  },
  {
    ...
    description: 'SofaWorks adalah ruang kerja bersama modern di Gedung Raja Sofa yang dirancang untuk produktivitas, fleksibilitas, dan kolaborasi bisnis. Kami menyediakan area meja kerja harian/bulanan, ruang rapat modular, dan private office untuk tim kecil. Dilengkapi internet serat optik cepat, mesin printer, area lounge, serta kopi/teh gratis.',
  ...
  },
  {
    ...
    description: 'Raja Sofa adalah produsen dan pusat kustomisasi sofa premium yang mengutamakan kekuatan rangka oven anti-rayap, busa anti-kempes, dan estetika bahan pelapis berkualitas. Kami melayani pembuatan sofa sudut L, minimalis, recliner, hingga sofa bed kustom. Nikmati garansi rangka kayu kokoh dan free ongkir wilayah Pekanbaru.',
    details: [
